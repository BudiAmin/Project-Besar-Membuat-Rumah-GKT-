...
pygame.display.set_caption("Project Besar")
...
while True:
    ...
    # Gambar matahari berbentuk lingkaran dengan faktor skala
    radius_matahari_skala = int(radius_matahari * faktor_skala_matahari)
    pygame.draw.circle(
        layar, warna_matahari, (x_matahari, y_matahari), radius_matahari_skala
    )
    ...
    for i in range(12):
        ...
        pos_awal = (
            x_matahari + int(radius_matahari_skala * 1.5 * math.cos(sudut)),
            y_matahari + int(radius_matahari_skala * 1.5 * math.sin(sudut)),
        )
        pos_akhir = (
            x_matahari + int(radius_matahari_skala * 2 * math.cos(sudut)),
            y_matahari + int(radius_matahari_skala * 2 * math.sin(sudut)),
        )
